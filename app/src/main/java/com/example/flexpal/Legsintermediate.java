...
public class Legsintermediate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legsintermediate);

        int[] cIcon = {R.drawable.inlwhighknee, R.drawable.inlwsquat,
                R.drawable.inlwnorcurl,R.drawable.inlwstssquat,R.drawable.inlwquadext,
                R.drawable.inlwsquatjump,R.drawable.inlwcalfraise,R.drawable.inlwcobrastr,
                R.drawable.inlwquadstrl,R.drawable.inlwquadstrr};

        for (int i = 0; i < cIcon.length && i < 10; i++) {
    ...
    public void startWorkout(){
        ...
        String[] cValues = {c1.getText().toString(), c2.getText().toString(), c3.getText().toString(), c4.getText().toString(),
                ...
                c9.getText().toString(), c10.getText().toString()};
        ...
        Intent intent = new Intent(Legsintermediate.this, WorkoutStartActivity.class);
