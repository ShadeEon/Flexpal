...
public class Legsbeginner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.side_hop,R.drawable.squats,R.drawable.side_lying_leg_lift,
                R.drawable.backward_and_forward_lunge,R.drawable.squats,
                R.drawable.donkey_kicks,R.drawable.quad_stretch_with_wall,
                R.drawable.wall_calf_raises,R.drawable.sumo_squat_calf_raises_with_wall,
                R.drawable.calf_stretch,R.drawable.side_lying_leg_lift,R.drawable.backward_and_forward_lunge,
                R.drawable.donkey_kicks,R.drawable.quad_stretch_with_wall,
                R.drawable.wall_calf_raises,R.drawable.sumo_squat_calf_raises_with_wall,R.drawable.calf_stretch};

        for (int i = 0; i < cIcon.length && i < 16; i++) {
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Legsbeginner.this, WorkoutStartActivity.class);
