...
public class Absbeginner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.jumping_jacks, R.drawable.abdominal_crunches, R.drawable.russian_twist,
                R.drawable.mountain_climber, R.drawable.heel_touch, R.drawable.leg_raises,
                R.drawable.plank, R.drawable.abdominal_crunches,  R.drawable.russian_twist,
                R.drawable.mountain_climber,  R.drawable.heel_touch, R.drawable.leg_raises,
                R.drawable.plank,  R.drawable.cobra_stretch};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Absbeginner.this, WorkoutStartActivity.class);
