...
public class ArmsIntermediate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.arm_circle, R.drawable.floor_triceps_dips,R.drawable.military_push_ups,R.drawable.alternating_hooks,
                R.drawable.floor_triceps_dips, R.drawable.military_push_ups,R.drawable.alternating_hooks,R.drawable.push_ups,
                R.drawable.burpees, R.drawable.arm_scissors,R.drawable.triceps_stretch,
                R.drawable.push_ups,R.drawable.burpees,R.drawable.triceps_stretch};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(ArmsIntermediate.this, WorkoutStartActivity.class);
