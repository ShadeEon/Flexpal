...
public class Chestadvance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chestadvance);

        int[] cIcon = {R.drawable.adcwjumpjack, R.drawable.adcwarmcircw, R.drawable.adcwarmcirccw,
                R.drawable.adcwshouldertap,R.drawable.adcwdecpush,R.drawable.adcwhindupush,R.drawable.adcwsakpu,
                R.drawable.adcwclpd,R.drawable.adcwshouldertap2,R.drawable.adcwdecpush2,
                R.drawable.adcwhindupush2,R.drawable.adcwsakpu2,R.drawable.adcwclpd2,R.drawable.adcwchildstr,
                R.drawable.adcwshoulderstr};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Chestadvance.this, WorkoutStartActivity.class);
