...
public class Armsadvance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_armsadvance);

        int[] cIcon = {R.drawable.adawarmcircw,R.drawable.adawarmcirccw,R.drawable.adawarmstr,
                R.drawable.adawtridip, R.drawable.adawupdownplank,R.drawable.adawatpu,
                R.drawable.adawsakpu,R.drawable.adawshouldertap,R.drawable.adawtridip2,R.drawable.adawupdownplank2,
                R.drawable.adawatpu2,R.drawable.adawsakpu2,R.drawable.adawshouldertap2,R.drawable.adawtristr,
                R.drawable.adawtristr,R.drawable.adawarmstr,R.drawable.adawbackstr};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Armsadvance.this, WorkoutStartActivity.class);
