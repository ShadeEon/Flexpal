...
public class Chestbeginner extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.jumping_jacks,R.drawable.push_ups,R.drawable.wide_arm_push_ups,
                R.drawable.triceps_dips,R.drawable.wide_arm_push_ups,R.drawable.knee_push_ups,
                R.drawable.cobra_stretch,R.drawable.chest_stretch};

        for (int i = 0; i < cIcon.length && i < 8; i++) {
    ...
    public void startWorkout(){
        ...
        String[] cTimeValues = {c1time.getText().toString(), c2time.getText().toString(), c3time.getText().toString(),
                ...
                c7time.getText().toString(), c8time.getText().toString()};

        int[] cIcon = {R.drawable.jumping_jacks,R.drawable.push_ups,R.drawable.wide_arm_push_ups,
                R.drawable.triceps_dips,R.drawable.wide_arm_push_ups,R.drawable.knee_push_ups,
                R.drawable.cobra_stretch,R.drawable.chest_stretch};

        Intent intent = new Intent(Chestbeginner.this, WorkoutStartActivity.class);
