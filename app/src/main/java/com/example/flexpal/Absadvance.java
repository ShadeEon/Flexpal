...
public class Absadvance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_absadvance);

        int[] cIcon = {R.drawable.adabwjumpjack, R.drawable.adabwsttsu, R.drawable.adabwhollowhold, R.drawable.adabwbicrun,
                R.drawable.adabwdktl, R.drawable.adabwdktr, R.drawable.adabwrevcrun, R.drawable.adabwsttsu2, R.drawable.adabwhollowhold2,
                R.drawable.adabwbicrun2, R.drawable.adabwdktl2, R.drawable.adabwdktr2, R.drawable.adabwrevcrun2, R.drawable.adabwplankjack,
                R.drawable.adabwcobrastr, R.drawable.adabwchildstr, R.drawable.adabwcatcowstr};

        for (int i = 0; i < cIcon.length && i < 17; i++) {
    ...
    private boolean resourceIdIsGif(int resourceId) {
        // Get the resource name
        String resourceName = getResources().getResourceName(resourceId).toLowerCase();

        // Check for the GIF extension
        return resourceName.endsWith("gif");
    }
    private boolean resourceIdIsImage(int resourceId) {
        // Get the resource name
        String resourceName = getResources().getResourceName(resourceId).toLowerCase();

        // Check for different image formats based on file extension
        return resourceName.endsWith("gif") ||
    ...
    public void startWorkout(){
        ...
        String[] cTimeValues = {c1time.getText().toString(), c2time.getText().toString(), c3time.getText().toString(),
                ...
                c16time.getText().toString(), c17time.getText().toString()};
        ...
        Intent intent = new Intent(Absadvance.this, WorkoutStartActivity.class);
