...
public class CooldownW extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cooldown_w);

        int[] cIcon = {R.drawable.cooltrir, R.drawable.cooltril,R.drawable.coolquadl,
                R.drawable.coolquadr,R.drawable.coolkneehug,R.drawable.coolback,
                R.drawable.coolarm,R.drawable.coolcobra,R.drawable.coolchild,R.drawable.coolcatcow};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(CooldownW.this, WorkoutStartActivity.class);
