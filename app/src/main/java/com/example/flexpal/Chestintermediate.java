...
public class Chestintermediate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.jumping_jacks, R.drawable.knee_push_ups,R.drawable.push_ups,R.drawable.wide_arm_push_ups,
                R.drawable.hindu_push_ups, R.drawable.staggered_push_ups,R.drawable.knee_push_ups,R.drawable.hindu_push_ups,
                R.drawable.declined_push_ups, R.drawable.staggered_push_ups,R.drawable.hindu_push_ups,R.drawable.cobra_stretch,
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Chestintermediate.this, WorkoutStartActivity.class);
