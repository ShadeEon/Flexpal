...
public class Legsadvance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legsadvance);

        int[] cIcon = {R.drawable.adlwhighknee, R.drawable.adlwlegswingl,R.drawable.adlwlegswingr,
                R.drawable.adlwburpees,R.drawable.adlwfwdlunge,R.drawable.adlwsidelungel,
                R.drawable.adlwsidelunger,R.drawable.adlwspltsquatl,R.drawable.adlwspltsquatr,
                R.drawable.adlwburpees2,R.drawable.adlwfwdlunge2,R.drawable.adlwsidelungel2,
                R.drawable.adlwsidelunger2,R.drawable.adlwspltsquatl2,R.drawable.adlwspltsquatr2,
                R.drawable.adlwwallsit,R.drawable.adabwcobrastr,R.drawable.adlwchildstr,
                R.drawable.adlwquadstrl,  R.drawable.adlwquadstrr};

        for (int i = 0; i < cIcon.length && i < 20; i++) {
    ...
    public void startWorkout(){
        ...
        String[] cValues = {c1.getText().toString(), c2.getText().toString(), c3.getText().toString(), c4.getText().toString(),
                ...
                c13.getText().toString(), c14.getText().toString(), c15.getText().toString(), c16.getText().toString(),
                c17.getText().toString(), c18.getText().toString(), c19.getText().toString(), c20.getText().toString()};
        ...
        String[] cTimeValues = {c1time.getText().toString(), c2time.getText().toString(), c3time.getText().toString(),
                ...
                c16time.getText().toString(), c17time.getText().toString(), c18time.getText().toString(),
                c19time.getText().toString(), c20time.getText().toString()};
        ...
        Intent intent = new Intent(Legsadvance.this, WorkoutStartActivity.class);
        ...
        Log.d("ICON", c1con.getDrawable().toString());
