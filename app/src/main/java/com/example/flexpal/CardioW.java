...
public class CardioW extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardio_w);

        int[] cIcon = {R.drawable.cardioburpees,
                R.drawable.cardiolunge,R.drawable.cardiojump,R.drawable.cardiorotationl,
                R.drawable.cardiorotationr,R.drawable.cardiodonkey,R.drawable.cardiojack,
                R.drawable.cardiohops,R.drawable.cardiolatstep,R.drawable.cardiodogl,
                R.drawable.cardiodogr,R.drawable.cardiohindupush};

        for (int i = 0; i < cIcon.length && i < 12; i++) {
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(CardioW.this, WorkoutStartActivity.class);
