...
public class Streching extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] cIcon = {R.drawable.strmountain, R.drawable.strupward,
                R.drawable.strbend,R.drawable.strlunge,R.drawable.strlow,
                R.drawable.strplank,R.drawable.strdog,R.drawable.strdownward,
                R.drawable.strbend2,R.drawable.strsalute};
    ...
    public void startWorkout(){
        ...
        Intent intent = new Intent(Streching.this, WorkoutStartActivity.class);
